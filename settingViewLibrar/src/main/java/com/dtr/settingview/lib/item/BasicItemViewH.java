...
public class BasicItemViewH extends FrameLayout {
	...
	private void readAttrs(Context context, AttributeSet attrs) {
		if (null != attrs) {
			...
			if (a.hasValue(R.styleable.SettingViewItem_background1)) {
				Drawable drawable = a.getDrawable(R.styleable.SettingViewItem_background1);
				if (null != drawable) {
			...
			if (a.hasValue(R.styleable.SettingViewItem_title1)) {
				String title = a.getString(R.styleable.SettingViewItem_title1);
