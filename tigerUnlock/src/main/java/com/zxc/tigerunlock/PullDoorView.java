...
public class PullDoorView extends RelativeLayout {
	...
	private void setupView() {
		...
		mImgView.setImageResource(R.drawable.logo); // 默认背景
		addView(mImgView);
		// 设置声音
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		String fangdao=getContext().getSharedPreferences("LOGIN", Context.MODE_PRIVATE).getString("PWD", "");
		switch (action) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if(text.getText().toString().equals(fangdao)) {
